...
import 'package:talecraft/controller/genre_details_controller.dart';
...
class GenreDetails extends StatelessWidget {
  final String name;
  const GenreDetails({super.key, required this.name});
  @override
  Widget build(BuildContext context) {
    var height = MediaQuery.of(context).size.height;
    var width = MediaQuery.of(context).size.width;
    return Scaffold(
      appBar: CustomAppBar(title: "${AppStrings.filter} - $name"),
      body: GetBuilder<GenreDetailsController>(
          init: GenreDetailsController(),
          builder: (controller) {
