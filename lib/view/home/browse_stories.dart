...
import '../../controller/browse_stories_controller.dart';
...
class BrowseStories extends StatelessWidget {
  final String name;
  final List<Story> list;
  const BrowseStories({super.key, required this.name, required this.list});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<BrowseStoriesController>(
          init: BrowseStoriesController(),
          builder: (controller) {
            return Padding(
                          ...
                          child: CupertinoScrollbar(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return getStoryItem(height, width, list[index]);
                              },
                            ),
                          ),
                        )
